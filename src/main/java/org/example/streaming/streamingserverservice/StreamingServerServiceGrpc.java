...
public final class StreamingServerServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "org.example.streaming.StreamingServerService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.UnaryRequest,
      org.example.streaming.streamingserverservice.UnaryResponse> getSendUnaryRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendUnaryRequest",
      requestType = org.example.streaming.streamingserverservice.UnaryRequest.class,
      responseType = org.example.streaming.streamingserverservice.UnaryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.UnaryRequest,
      org.example.streaming.streamingserverservice.UnaryResponse> getSendUnaryRequestMethod() {
    io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.UnaryRequest, org.example.streaming.streamingserverservice.UnaryResponse> getSendUnaryRequestMethod;
      ...
      synchronized (StreamingServerServiceGrpc.class) {
        if ((getSendUnaryRequestMethod = StreamingServerServiceGrpc.getSendUnaryRequestMethod) == null) {
          StreamingServerServiceGrpc.getSendUnaryRequestMethod = getSendUnaryRequestMethod =
              io.grpc.MethodDescriptor.<org.example.streaming.streamingserverservice.UnaryRequest, org.example.streaming.streamingserverservice.UnaryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendUnaryRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.streaming.streamingserverservice.UnaryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.streaming.streamingserverservice.UnaryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.StreamServerRequest,
      org.example.streaming.streamingserverservice.StreamServerResponse> getStreamServerRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamServerRequest",
      requestType = org.example.streaming.streamingserverservice.StreamServerRequest.class,
      responseType = org.example.streaming.streamingserverservice.StreamServerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.StreamServerRequest,
      org.example.streaming.streamingserverservice.StreamServerResponse> getStreamServerRequestMethod() {
    io.grpc.MethodDescriptor<org.example.streaming.streamingserverservice.StreamServerRequest, org.example.streaming.streamingserverservice.StreamServerResponse> getStreamServerRequestMethod;
      ...
      synchronized (StreamingServerServiceGrpc.class) {
        if ((getStreamServerRequestMethod = StreamingServerServiceGrpc.getStreamServerRequestMethod) == null) {
          StreamingServerServiceGrpc.getStreamServerRequestMethod = getStreamServerRequestMethod =
              io.grpc.MethodDescriptor.<org.example.streaming.streamingserverservice.StreamServerRequest, org.example.streaming.streamingserverservice.StreamServerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamServerRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.streaming.streamingserverservice.StreamServerRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.streaming.streamingserverservice.StreamServerResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sendUnaryRequest(org.example.streaming.streamingserverservice.UnaryRequest request,
        io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.UnaryResponse> responseObserver) {
     ...
     * </pre>
     */
    default void streamServerRequest(org.example.streaming.streamingserverservice.StreamServerRequest request,
        io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.StreamServerResponse> responseObserver) {
  ...
  public static final class StreamingServerServiceStub
     ...
     * </pre>
     */
    public void sendUnaryRequest(org.example.streaming.streamingserverservice.UnaryRequest request,
        io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.UnaryResponse> responseObserver) {
     ...
     * </pre>
     */
    public void streamServerRequest(org.example.streaming.streamingserverservice.StreamServerRequest request,
        io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.StreamServerResponse> responseObserver) {
  ...
  public static final class StreamingServerServiceBlockingStub
     ...
     * </pre>
     */
    public org.example.streaming.streamingserverservice.UnaryResponse sendUnaryRequest(org.example.streaming.streamingserverservice.UnaryRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<org.example.streaming.streamingserverservice.StreamServerResponse> streamServerRequest(
        org.example.streaming.streamingserverservice.StreamServerRequest request) {
  ...
  public static final class StreamingServerServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.streaming.streamingserverservice.UnaryResponse> sendUnaryRequest(
        org.example.streaming.streamingserverservice.UnaryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_UNARY_REQUEST:
          serviceImpl.sendUnaryRequest((org.example.streaming.streamingserverservice.UnaryRequest) request,
              (io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.UnaryResponse>) responseObserver);
          break;
        case METHODID_STREAM_SERVER_REQUEST:
          serviceImpl.streamServerRequest((org.example.streaming.streamingserverservice.StreamServerRequest) request,
              (io.grpc.stub.StreamObserver<org.example.streaming.streamingserverservice.StreamServerResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.example.streaming.streamingserverservice.UnaryRequest,
              org.example.streaming.streamingserverservice.UnaryResponse>(
                service, METHODID_SEND_UNARY_REQUEST)))
        .addMethod(
          getStreamServerRequestMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              org.example.streaming.streamingserverservice.StreamServerRequest,
              org.example.streaming.streamingserverservice.StreamServerResponse>(
  ...
  private static abstract class StreamingServerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.streaming.streamingserverservice.StreamingServerServiceProto.getDescriptor();
    }
